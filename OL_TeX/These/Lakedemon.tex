...
\lemm dfc2. Soient $\theta>1$, $n\in\ob N$ et  $f\in\sc C^n\b([\e,\infty[,[\e,\infty[\b)$ et $g\in \sc C^{n+1}\b([\e,\infty[,[\e,\infty[\b)$ deux applications satisfaisant les hypoth\`eses du lemme \eqrefn{dfc3}. 
